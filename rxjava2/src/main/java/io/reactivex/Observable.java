...
public abstract class Observable<T> implements ObservableSource<T> {
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.CUSTOM)
    public final Observable<T> observeOn2(Scheduler scheduler) {
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        ObjectHelper.verifyPositive(bufferSize(), "bufferSize");
        return RxJavaPlugins.onAssembly(new ObservableObserveOn2<T>(this, scheduler, false, bufferSize()));
    }
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.CUSTOM)
    public final Observable<T> observeOn3(Scheduler scheduler) {
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        ObjectHelper.verifyPositive(bufferSize(), "bufferSize");
        return RxJavaPlugins.onAssembly(new ObservableObserveOn3<T>(this, scheduler, false, bufferSize()));
    }
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.CUSTOM)
    public final Observable<T> subscribeOn2(Scheduler scheduler) {
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return RxJavaPlugins.onAssembly(new ObservableSubscribeOn2<T>(this, scheduler));
    }
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.CUSTOM)
    public final Observable<T> subscribeOn3(Scheduler scheduler) {
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return RxJavaPlugins.onAssembly(new ObservableSubscribeOn3<T>(this, scheduler));
    }
